    ...
    <div class="table-responsive">
        ...
        <table class="table m-b-none b-t table-hover">
            ...
            <tr>
                ...
                <td align="center"><a class="option" onclick="viewBox('view','单品明细','{{url('detail', ['id' => $row['id']])}}');" href="javascript:;"> 点击明细 </a></td>
                ...
                <td align="center"><a class="option" href="{{url('material/detail', ['promotion_id' => $row['id']])}}">{{$materials[$row->material_id]['name']}}({{(int)$_materials[$row->id]}})点击</a></td>
                <td align="left">
