<form id="search-form" class="form-inline" name="mysearch" action="{{url()}}" method="get">
    ...
    @if(isset($access['create']))
        <button type="button" class="option" data-toggle="dialog-form" data-title="新建" data-url="{{url('create', ['id'=>$row->id])}}" data-id="window-form" class="btn btn-sm btn-info"><i class="icon icon-plus"></i> 新建</button>
    @endif
