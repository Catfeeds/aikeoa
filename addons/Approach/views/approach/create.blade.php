                        ...
                        <span class="y corner_12"></span>
                            ...
                            <div style="margin:10px;" class="form-wrapper">
                                ...
                                <table class="table" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" colspan="4">
                                            经销商配送：{{$form->option('data_11', 'approach.distribution')}}，经销商维护：专职导购{{$form->text('data_12')}}
                                ...
                                <div class="b-l b-r b-t padder-xs">进店单品明细</div>
                                ...
                                <table class="table" width="100%">
                                    ...
                                    <tr>
                                        <th align="left" colspan="2">客户经理复盘:</th>
                                    </tr>
                                    <tr>
                                        <td align="left" colspan="2">
                                            复盘意见：{{$form->text('data_56')}}
                                            &nbsp;复盘时间：{{$form->auto('data_57')}}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th align="left" colspan="2">订单助理兑现:</th>
                                    </tr>
                                    <tr>
                                        <td align="left" colspan="2">
                                            兑现订单号：{{$form->text('data_58')}}
                                            &nbsp;兑现时间：{{$form->auto('data_59')}}
                                        </td>
                                    </tr>
...
@include('approach/create/footer')
...
$(function() {
    approach_data_60_box("{{$form->data['data_60']}}");
